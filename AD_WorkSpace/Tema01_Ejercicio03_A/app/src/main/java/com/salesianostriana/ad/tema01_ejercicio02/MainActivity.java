...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tiempoDescarga = String.format("%d min, %d sec",
                TimeUnit.MILLISECONDS.toMinutes(timeEnd-timeStart),
                TimeUnit.MILLISECONDS.toSeconds(timeEnd-timeStart));
        Log.i("DESCARGA TAM", Integer.toString(contBytes) + " bytes -- tiempo de descarga: "+tiempoDescarga);
